...
(
	[iComprobanteDetalle] INT NOT NULL PRIMARY KEY DEFAULT NEXT VALUE FOR seq_comprobantes_detalle,
    ...
    CONSTRAINT [FK_ComprobanteDetalle_ToComprobante] FOREIGN KEY ([iComprobante]) REFERENCES sch_facturacion.Comprobante(iComprobante), 
    CONSTRAINT [FK_ComprobanteDetalle_ToProducto] FOREIGN KEY ([iProducto]) REFERENCES sch_facturacion.Producto(iProducto)
)
