...
(
	[iId] INT NOT NULL PRIMARY KEY DEFAULT NEXT VALUE FOR seq_catalogo_detalle, 
    ...
    CONSTRAINT [FK_CatalogoDetalle_ToCatalogo] FOREIGN KEY (iCatalogo) REFERENCES sch_maestro.Catalogo([iId]),
)
